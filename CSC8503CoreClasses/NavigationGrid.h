...
namespace NCL {
	namespace CSC8503 {
		...
		public:
			NavigationGrid();
			NavigationGrid(const std::string&filename, const Vector3 topLeft);
			~NavigationGrid();
			...
			Vector3 GetLockButton() { return lockButton; }
			Vector3 GetMazeDefButton() { return mazeDefButton; }
			Vector3 GetExitDefButton() { return exitDefButton; }
		...
		protected:
			...
			int gridHeight;
			Vector3 lockButton;
			Vector3 exitDefButton;
			Vector3 mazeDefButton;
			Vector3 topLeft;
			GridNode* allNodes;
		};
	}
